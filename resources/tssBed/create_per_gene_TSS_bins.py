...
parser = argparse.ArgumentParser(description='Create windows around TSS for each gene in GTF file')
...
for geneID,metaData in genes_dict.items():
	...
	for i,j in enumerate(r):
		...
		outList = [metaData['chrom'],str(s),str(e),regionName,'.',metaData['strand']]
		outStr = "\t".join(outList)
