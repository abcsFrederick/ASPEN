...
For a typical 2 sample analyis with 2 replicates each this folder should look like this:
...
├── results
    ├── peaks
        └── macs2
            ├── sample1_replicate1_sample1_replicate2.pooled.tagAlign.gz
            ├── sample1_replicate1.macs2_control_lambda.bdg
            ├── sample1_replicate1.macs2.fixed_width.narrowPeak
            ├── sample1_replicate1.macs2.narrowPeak
            ├── sample1_replicate1.macs2.narrowPeak.annotated
            ├── sample1_replicate1.macs2.narrowPeak.annotation_distribution
            ├── sample1_replicate1.macs2.narrowPeak.annotation_summary
            ├── sample1_replicate1.macs2.narrowPeak.genelist
            ...
            │   ├── seq.autonorm.tsv
            │   └── target.fa
            ├── sample1_replicate1.macs2_peaks.xls
            ├── sample1_replicate1.macs2_summits.bed
            ├── sample1_replicate1.macs2_treat_pileup.bdg
            ├── sample1_replicate1.macs2.unfiltered.narrowPeak
            ├── sample1_replicate1.macs2.unfiltered.narrowPeak.annotated
            ├── sample1_replicate1.macs2.unfiltered.narrowPeak.annotation_distribution
            ├── sample1_replicate1.macs2.unfiltered.narrowPeak.annotation_summary
            ├── sample1_replicate1.macs2.unfiltered.narrowPeak.genelist
            ├── sample1_replicate2.macs2_control_lambda.bdg
            ├── sample1_replicate2.macs2.fixed_width.narrowPeak
            ├── sample1_replicate2.macs2.narrowPeak
            ├── sample1_replicate2.macs2.narrowPeak.annotated
            ├── sample1_replicate2.macs2.narrowPeak.annotation_distribution
            ├── sample1_replicate2.macs2.narrowPeak.annotation_summary
            ├── sample1_replicate2.macs2.narrowPeak.genelist
            ...
            │   ├── seq.autonorm.tsv
            │   └── target.fa
            ├── sample1_replicate2.macs2_peaks.xls
            ├── sample1_replicate2.macs2_summits.bed
            ├── sample1_replicate2.macs2_treat_pileup.bdg
            ├── sample1_replicate2.macs2.unfiltered.narrowPeak
            ├── sample1_replicate2.macs2.unfiltered.narrowPeak.annotated
            ├── sample1_replicate2.macs2.unfiltered.narrowPeak.annotation_distribution
            ├── sample1_replicate2.macs2.unfiltered.narrowPeak.annotation_summary
            ├── sample1_replicate2.macs2.unfiltered.narrowPeak.genelist
            ...
            │   ├── seq.autonorm.tsv
            │   └── target.fa
            ├── sample1.macs2.pooled_control_lambda.bdg
            ├── sample1.macs2.pooled.narrowPeak
            ├── sample1.macs2.pooled_peaks.xls
            ├── sample1.macs2.pooled_summits.bed
            ├── sample1.macs2.pooled_treat_pileup.bdg
            ...
            │       ├── sample2_vs_sample1.html
            │       └── sample2_vs_sample1.tsv
            ├── sample2_replicate1_sample2_replicate2.pooled.tagAlign.gz
            ├── sample2_replicate1.macs2_control_lambda.bdg
            ├── sample2_replicate1.macs2.fixed_width.narrowPeak
            ├── sample2_replicate1.macs2.narrowPeak
            ├── sample2_replicate1.macs2.narrowPeak.annotated
            ├── sample2_replicate1.macs2.narrowPeak.annotation_distribution
            ├── sample2_replicate1.macs2.narrowPeak.annotation_summary
            ├── sample2_replicate1.macs2.narrowPeak.genelist
            ...
            │   ├── seq.autonorm.tsv
            │   └── target.fa
            ├── sample2_replicate1.macs2_peaks.xls
            ├── sample2_replicate1.macs2_summits.bed
            ├── sample2_replicate1.macs2_treat_pileup.bdg
            ├── sample2_replicate1.macs2.unfiltered.narrowPeak
            ├── sample2_replicate1.macs2.unfiltered.narrowPeak.annotated
            ├── sample2_replicate1.macs2.unfiltered.narrowPeak.annotation_distribution
            ├── sample2_replicate1.macs2.unfiltered.narrowPeak.annotation_summary
            ├── sample2_replicate1.macs2.unfiltered.narrowPeak.genelist
            ├── sample2_replicate2.macs2_control_lambda.bdg
            ├── sample2_replicate2.macs2.fixed_width.narrowPeak
            ├── sample2_replicate2.macs2.narrowPeak
            ├── sample2_replicate2.macs2.narrowPeak.annotated
            ├── sample2_replicate2.macs2.narrowPeak.annotation_distribution
            ├── sample2_replicate2.macs2.narrowPeak.annotation_summary
            ├── sample2_replicate2.macs2.narrowPeak.genelist
            ...
            │   ├── seq.autonorm.tsv
            │   └── target.fa
            ├── sample2_replicate2.macs2_peaks.xls
            ├── sample2_replicate2.macs2_summits.bed
            ├── sample2_replicate2.macs2_treat_pileup.bdg
            ├── sample2_replicate2.macs2.unfiltered.narrowPeak
            ├── sample2_replicate2.macs2.unfiltered.narrowPeak.annotated
            ├── sample2_replicate2.macs2.unfiltered.narrowPeak.annotation_distribution
            ├── sample2_replicate2.macs2.unfiltered.narrowPeak.annotation_summary
            ├── sample2_replicate2.macs2.unfiltered.narrowPeak.genelist
            ...
            │   ├── seq.autonorm.tsv
            │   └── target.fa
            ├── sample2.macs2.pooled_control_lambda.bdg
            ├── sample2.macs2.pooled.narrowPeak
            ├── sample2.macs2.pooled_peaks.xls
            ├── sample2.macs2.pooled_summits.bed
            ├── sample2.macs2.pooled_treat_pileup.bdg
            ...
            │   ├── ROI.annotation_distribution
            │   ├── ROI.annotation_summary
            │   ├── ROI.bed
            │   ├── ROI.bed.annotated
            │   ├── ROI.genelist
            │   ├── ROI.gtf
            │   ├── ROI.narrowPeak
            │   ├── ROI.renormalized.narrowPeak
            │   └── Rplots.pdf
            ├── ROI.reads_counts.tsv
            ├── ROI.reads_scaled_counts.tsv
            ├── ROI.tn5sites_counts.tsv
            └── ROI.tn5sites_scaled_counts.tsv
```
...
| `*.narrowPeak.annotated` | peak calls annotated using ChIPseeker |
...
| `DiffATAC/reads` | folder containing differential open chromatin results: <br> - computated using read counts in MACS2 regions of interest (ROIs) <br> - `all_diff_atacs.html` HTML report aggregated accross all contrasts from `contrasts.tsv` <br> - `all_diff_atacs.tsv` DESeq2 results in TSV format aggregated accross all contrasts from `contrasts.tsv` <br> - HTML and TSV file each per contrast in `contrasts.tsv` |
| `DiffATAC/tn5sites` | folder containing differential open chromatin results: <br> - computated using Tn5 nicking site counts in MACS2 regions of interest (ROIs) <br> - `all_diff_atacs.html` HTML report aggregated accross all contrasts from `contrasts.tsv` <br> - `all_diff_atacs.tsv` DESeq2 results in TSV format aggregated accross all contrasts from `contrasts.tsv` <br> - HTML and TSV file each per contrast in `contrasts.tsv` |
| `fixed_width` | `fixed_width` can be set in `config.yaml` to create peaks of a user defined fixed width (default 500bp). This folder contains: <br> - `*.renormalized.fixed_width.consensus.narrowPeak` per sample; used to generate MACS2 regions of interest (ROI) peaks which are used to generate a reads or Tn5 sites counts matrix for DESeq2 <br> - ROI related files: `ROI.bed`, `ROI.bed.annotated`, `ROI.annotation_summary`, `ROI.annotation_distribution`|
| `ROI.read_counts.tsv` | read counts in MACS2 ROIs using featureCounts |
| `ROI.reads_scaled_counts.tsv` | `ROI.read_counts.tsv` scaled using spike-in scaling factors |
| `ROI.tn5sites_counts.tsv` | Tn5 nicking site counts in MACS2 ROIs using featureCounts |
| `ROI.tn5sites_scaled_counts.tsv` | `ROI.tn5sites_counts.tsv` scaled using spike-in scaling factors |

### Genrich output folder

For a typical 2 sample analyis with 2 replicates each this folder should look like very similar to the MACS2 output structure described above.
...
> DISCLAIMER: This folder hierarchy is significantly different than v1.0.6 and is subject to change with version.