...
# heatmap_matrix=assay(rld2)
# interesting_genes=c(up_roi$Geneid,down_roi$Geneid)
# heatmap_matrix %>% filter( Geneid %in% interesting_genes ) -> matrix_for_heatmap
# Heatmap(matrix = t(scale(t(matrix_for_heatmap),scale = TRUE)),show_row_names = FALSE,name=" ")
# ```
