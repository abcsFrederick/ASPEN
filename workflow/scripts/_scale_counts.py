...
def main(scaling_factors_file, counts_file, output_file):
    ...
    scaling_factors = dict(zip(scaling_factors_df['replicateName'], scaling_factors_df['scalingFactor']))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--scaling_factors', required=True, help='Path to the scaling factors TSV file')
    parser.add_argument('--counts_file', required=True, help='Path to the counts TSV file')
    parser.add_argument('--output_file', required=True, help='Path to save the scaled counts output TSV file')
