...
degfiles <- allfiles[grepl("\\.tsv$", allfiles) & !grepl("normalized_counts\\.tsv$", allfiles)]
...
read_deg_file <- function(deg_file) {
  ...
  required_cols <- c("Geneid", "log2FoldChange", "pvalue", "padj")
  missing_cols <- setdiff(required_cols, colnames(df))
  if (length(missing_cols) > 0) {
    stop(paste("ERROR:", deg_file, "is missing required DEG columns:", paste(missing_cols, collapse = ", ")))
  }
